...
if __name__ == '__main__':
    ...
    # y_score_test_svm2 = estimator_svm._predict_proba_lr(X_test2)[:, 1].tolist()
    # # 模型6
    ...
    #              # ['RF2', y_score_test_rf2],
    #          ],
    #          save_path=os.path.join(save_dir, 'dca-gpc3-train.jpg')
    #          )
    #
    ...
    y_score_test_dt2 = estimator_dt.predict_proba(X_test1)[:, 1]  # 预测概率
    estimator_dt.fit(X_extest1, y_extest1)
    y_score_test_dt3 = estimator_dt.predict_proba(X_test1)[:, 1]  # 预测概率
    # # print('y_score_test_dt:', y_score_test_dt.tolist())
    #
    # # 模型3
    #   estimator_rf = RandomForestClassifier(n_estimators=120, max_depth=3, criterion='gini', n_jobs=1)
    ...
    plot_DCA(y_label=y_train1,
             y_scores=[
                 ['Train', y_score_test_dt1],
             ],
             save_path = os.path.join(save_dir, '20221226ki76DTtest.jpg'))
    plot_DCA(y_label=y_test1,
             y_scores=[
                 ['Test', y_score_test_dt2],
             ],
             save_path = os.path.join(save_dir, '20221226ki76DTtest.jpg'))
             # save_path = os.path.join(save_dir, ax=ax))
    plot_DCA(y_label=y_extest1,
             y_scores=[
                 ['Ex-validation', y_score_test_dt3],
             ],
             save_path = os.path.join(save_dir, '20221226ki76DTextest.jpg'))