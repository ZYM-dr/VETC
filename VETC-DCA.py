...
if __name__ == '__main__':
    ...
    # df_train1 = pd.read_excel('D:/VETC_RADIOMICS.xlsx',sheet_name='Sheet3')

    df_test1 = pd.read_excel('VETCmodel_data.xlsx', sheet_name='Train')
    df_test2 = pd.read_excel('VETCmodel_data.xlsx', sheet_name='Intest')
    df_test3 = pd.read_excel('VETCmodel_data.xlsx', sheet_name='Extest')
    ...
    # df_test4 = pd.read_excel('VETC_RADIOMICS.xlsx', sheet_name='intest_CRIR')
    # df_test5 = pd.read_excel('VETC_RADIOMICS.xlsx', sheet_name='intest_CRIPR')
    ...
    # df_test3 = pd.read_excel('VETC_RADIOMICS.xlsx', sheet_name='train_PR')
    # df_test4 = pd.read_excel('VETC_RADIOMICS.xlsx', sheet_name='train_CRIR')
    # df_test5 = pd.read_excel('VETC_RADIOMICS.xlsx', sheet_name='train_CRIPR')
    #
    ...
    # df_test4 = pd.read_excel('VETC_RADIOMICS.xlsx', sheet_name='validaton1_CRIR')
    # df_test5 = pd.read_excel('VETC_RADIOMICS.xlsx', sheet_name='validaton1_CRIPR')
    #
    ...
    # df_test4 = pd.read_excel('VETC_RADIOMICS.xlsx', sheet_name='validaton2_CRIR')
    # df_test5 = pd.read_excel('VETC_RADIOMICS.xlsx', sheet_name='validaton2_CRIPR')
    ...
    # # # 模型4
    # estimator_lr = LogisticRegression(C=0.5,
    ...
    plot_DCA(y_label=y_train1,
             y_scores=[
                 ['Train', y_score_test_lr1],
             ],
             save_path = os.path.join(save_dir, 'VETC-DCA1.jpg'))
